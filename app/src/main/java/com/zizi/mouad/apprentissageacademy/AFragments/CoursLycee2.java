 ...
 */
public class CoursLycee2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_cours_lycee2, container, false);
        expListView = v.findViewById(R.id.exp_list_lyc2);
        prepareListData();
