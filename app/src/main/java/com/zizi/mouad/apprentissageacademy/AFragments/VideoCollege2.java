 ...
 */
public class VideoCollege2 extends Fragment {
    private ExpandableListView expandableListView;
    private List<String> listDataHeader;
    private HashMap<String, List<String>> listDataChild;
    private ListCoursAdapter listAdapter;

    public VideoCollege2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v = inflater.inflate(R.layout.fragment_video_college2, container, false);
        expandableListView = v.findViewById(R.id.exp_list_colv2);
        prepareListData();
